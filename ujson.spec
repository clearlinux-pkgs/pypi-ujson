...
Source0  : https://files.pythonhosted.org/packages/21/93/ba928551a83251be01f673755819f95a568cda0bfb9e0859be80086dce93/ujson-4.3.0.tar.gz
...
%prep
%setup -q -n ujson-4.3.0
cd %{_builddir}/ujson-4.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637604578
...
cp %{_builddir}/ujson-4.3.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/ujson/0a8a0c4dd38dfac034078c7f3e0c16ff489d6646
cp %{_builddir}/ujson-4.3.0/deps/double-conversion/COPYING %{buildroot}/usr/share/package-licenses/ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
cp %{_builddir}/ujson-4.3.0/deps/double-conversion/LICENSE %{buildroot}/usr/share/package-licenses/ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
