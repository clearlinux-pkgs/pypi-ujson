...
%prep
%setup -q -n ujson-5.1.0
cd %{_builddir}/ujson-5.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641421412
...
cp %{_builddir}/ujson-5.1.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/ujson/0a8a0c4dd38dfac034078c7f3e0c16ff489d6646
cp %{_builddir}/ujson-5.1.0/deps/double-conversion/COPYING %{buildroot}/usr/share/package-licenses/ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
cp %{_builddir}/ujson-5.1.0/deps/double-conversion/LICENSE %{buildroot}/usr/share/package-licenses/ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
