...
Source0  : https://files.pythonhosted.org/packages/e4/fc/2dee0e78162aa1ad03dadde9a9b5c281d6f8bb0eed6810a270486d8fc041/ujson-5.2.0.tar.gz
...
%prep
%setup -q -n ujson-5.2.0
cd %{_builddir}/ujson-5.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651600382
...
cp %{_builddir}/ujson-5.2.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-ujson/0a8a0c4dd38dfac034078c7f3e0c16ff489d6646
cp %{_builddir}/ujson-5.2.0/deps/double-conversion/COPYING %{buildroot}/usr/share/package-licenses/pypi-ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
cp %{_builddir}/ujson-5.2.0/deps/double-conversion/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
