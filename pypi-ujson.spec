...
Source0  : https://files.pythonhosted.org/packages/fb/94/44fbbb059fe5d295f1f73e731a0b9c2e1b5073c2c6b58bb9c068715e9b72/ujson-5.4.0.tar.gz
...
%prep
%setup -q -n ujson-5.4.0
cd %{_builddir}/ujson-5.4.0
pushd ..
cp -a ujson-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657037456
...
cp %{_builddir}/ujson-5.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-ujson/0a8a0c4dd38dfac034078c7f3e0c16ff489d6646
cp %{_builddir}/ujson-5.4.0/deps/double-conversion/COPYING %{buildroot}/usr/share/package-licenses/pypi-ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
cp %{_builddir}/ujson-5.4.0/deps/double-conversion/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ujson/8d434c9c1704b544a8b0652efbc323380b67f9bc
