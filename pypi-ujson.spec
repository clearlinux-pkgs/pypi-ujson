...
Source0  : https://files.pythonhosted.org/packages/6e/54/6f2bdac7117e89a47de4511c9f01732a283457ab1bf856e1e51aa861619e/ujson-5.9.0.tar.gz
...
%prep
%setup -q -n ujson-5.9.0
cd %{_builddir}/ujson-5.9.0
pushd ..
cp -a ujson-5.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702931593
